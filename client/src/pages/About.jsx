  ...
  return (
    <div className="pastel-page text-text-main py-16 px-6 lg:px-8 max-w-5xl mx-auto">
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl font-extrabold text-text-main leading-tight">
          About StudyPulse AI 🌱
        </h1>
        <p className="mt-4 text-sm sm:text-base text-text-muted max-w-2xl mx-auto font-semibold">
      ...
      <div className="space-y-12">
        <section className="liquid-card p-8">
          <div className="liquid-card-content">
            <h2 className="text-xl font-extrabold text-text-main mb-4 flex items-center gap-2">
        ...
        <section className="grid gap-6 md:grid-cols-2">
          <div className="liquid-card liquid-card-hover p-6">
            <div className="liquid-card-content">
              <h3 className="text-lg font-extrabold text-text-main mb-2 flex items-center gap-2">
        ...
        <section className="liquid-card p-8 text-center">
          <div className="liquid-card-content">
            <h2 className="text-lg font-extrabold text-text-main mb-2">Our Technology</h2>
            <p className="text-xs text-text-muted max-w-xl mx-auto mb-6 font-semibold">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {['React 19', 'Tailwind CSS', 'Node.js/Express', 'Python FastAPI'].map((t, idx) => (
                <div key={idx} className="bg-white/50 border border-lavender/30 rounded-full py-2.5 px-4 text-xs font-bold text-text-main shadow-sm">
                  {t}
                </div>
              ))}
            </div>
